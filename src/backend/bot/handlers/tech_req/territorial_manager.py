...
router = Router(name="technical_request_kru")
...
@router.callback_query(F.data == kru_tech_req_history.callback_data)
async def kru_history(callback: CallbackQuery):
    pass


@router.callback_query(F.data == kru_tech_req_waiting.callback_data)
async def kru_waiting(callback: CallbackQuery):
    pass
