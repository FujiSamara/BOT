...
from db.service.expenditure import (
    create_expenditure,
    find_expenditures,
    get_chapters,
...
from db.service.technical_request import (
    close_request,
    counting_date_sla,
...
from db.service.worktime import (
    create_worktime,
    dump_worktime,
    export_worktimes,
