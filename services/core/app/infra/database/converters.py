...
scope_decode_dict = {
    ...
    # Knowledge base
    FujiScope.crm_product_read: "CRM продукция просмотр",
    FujiScope.crm_marketing_read: "CRM маркетинг просмотр",
    FujiScope.crm_staff_read: "CRM сотрудники просмотр",
    FujiScope.crm_purchases_read: "CRM закупки просмотр",
    FujiScope.crm_cd_read: "CRM ЦД просмотр",
    FujiScope.crm_control_read: "CRM контроль просмотр",
    FujiScope.crm_accounting_read: "CRM бухгалтерия просмотр",
    FujiScope.crm_product_write: "CRM продукция редактирование",
    FujiScope.crm_marketing_write: "CRM маркетинг редактирование",
    FujiScope.crm_staff_write: "CRM сотрудники редактирование",
    FujiScope.crm_purchases_write: "CRM закупки редактирование",
    FujiScope.crm_cd_write: "CRM ЦД редактирование",
    FujiScope.crm_control_write: "CRM контроль редактирование",
    FujiScope.crm_accounting_write: "CRM бухгалтерия редактирование",
    # BOT
