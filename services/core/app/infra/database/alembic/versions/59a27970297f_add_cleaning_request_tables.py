...
Revision ID: 59a27970297f
Revises: 7373aeb0e65f
Create Date: 2024-12-31 17:09:49.682929
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("confirmation_description", sa.String(), nullable=False),
        sa.Column("close_date", sa.DateTime(), nullable=False),
        sa.Column("close_description", sa.String(), nullable=False),
        sa.Column("id", sa.Integer(), nullable=False),
