...
from app.schemas import ExpenditureSchema, TalbeInfoSchema, QuerySchema
...
) -> ExpenditureSchema | None:
    """Returns expenditure by given `id`."""
    return services.get_expenditure_by_id(id)
